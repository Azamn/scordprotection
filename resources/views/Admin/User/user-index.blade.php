                                    ...
                                    <table class="table table-styling" id="category-table">
                                        ...
                                        @foreach($users as $u)
                                            ...
                                            <tr id="{{$u->id}}">
                                                ...
                                                <td >
                                                    @if($u->email_verified_at)
                                                        <div class="checkbox checkbox-solid-success">
                                                            <input id="solid1" type="checkbox" disabled="" checked="" >
                                                            <label for="solid1"></label>
                                                        </div>
                                                        @else
                                                        <div class="checkbox checkbox-solid-danger">
                                                            <input id="solid1" type="checkbox" disabled="" >
                                                            <label for="solid1"></label>
                                                        </div>
                                                    @endif
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-outline-success"  href="/admin/users/{{$u->id}}" type="button">Details</a>
