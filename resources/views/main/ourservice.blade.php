                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div>
                            ...
                            ipsum volutpat quis. A true story, that never
                            been told!. Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, <br> <br> facilisis
                            ut venenatis eu, sodales vel dolor. The most happiest time of the day!. Morbi sagittis, sem
                    ...
                    <div class="col-lg-6 mt-10"><img src="{{{asset('images/scordimg/bg.jpg')}}}" width="100%" alt="Cannot show img"></div>
                </div>
